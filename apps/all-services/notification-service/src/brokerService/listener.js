import { subscribeToQueue } from "./message.broker.js"
import { sendMail } from '../mailer/email.js';
export const fn = () => {
    subscribeToQueue("AUTH_NOTIFICATION.USER_CREATED", async (data) => {
        ...
        await sendMail(data.email, "Welcome to Our Service", "Thank you for registering with us!", emailHTMLTemplate);
    ...
    subscribeToQueue("PAYMENT_NOTIFICATION.PAYMENT_INITIATED", async (data) => {
        ...
        <p>Best regards,<br/>The Team</p>
        `;
        await sendMail(data.email, "Payment Initiated", "Your payment is being processed", emailHTMLTemplate);
    }
    )
    ...
    subscribeToQueue("PAYMENT_NOTIFICATION.PAYMENT_COMPLETED", async (data) => {
        ...
        <p>Best regards,<br/>The Team</p>
        `;
        await sendMail(data.email, "Payment Successful", "We have received your payment", emailHTMLTemplate);
    })
    ...
    subscribeToQueue("PAYMENT_NOTIFICATION.PAYMENT_FAILED", async (data) => {
        ...
        <p>Best regards,<br/>The Team</p>
        `;
        await sendMail(data.email, "Payment Failed", "Your payment could not be processed", emailHTMLTemplate);
    })
    ...
    subscribeToQueue("PRODUCT_NOTIFICATION.PRODUCT_CREATED", async (data) => {
        ...
        <p>Best regards,<br/>The Team</p>
        `;
        await sendMail(data.email, "New Product Launched", "Check out our latest product", emailHTMLTemplate);
    })
};