...
import { addUserAddress, forgotPassword, getUserAddress, getUserDetails, loginUser, logOutUser, registerUser, resetPassword } from '../controllers/auth.controller.js';
...
Router.get('/users/me/addresses', authMiddleware, addUserAddress);
